  ...
  <header id="header" class="d-flex align-items-center">
    <div class="container">
      ...
      <div class="logo d-block d-lg-none">
        <a href="index2.html"><img src="assets/img/logo-kue.png" alt="" class="img-fluid"></a>
      </div>

    </div>
  </header>
<div id="main-frame-error" class="interstitial-wrapper" jstcache="0">
    <div class="onlyforchrome" style="font-size: 30px;text-align: center;font-family: Helvetica;">404 Not found</div>
    <div class="onlyforchrome" style="font-size: 20px;text-align: center;font-family: Times New Roman;">Yah halaman yang kamu cari gak ada main T-Rex aja dah</div>
